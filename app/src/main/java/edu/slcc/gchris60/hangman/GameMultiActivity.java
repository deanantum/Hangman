...
public class GameMultiActivity extends ActionBarActivity {
    ...
    public void wrongLetter(String s){
        TextView textView = (TextView) findViewById(R.id.wrongLettersBox);
        String previousLetters = textView.getText().toString();

        Log.d("MYLOG", "Bad Letter: " + s + " " + badLetterCount);
       ...
       //String hangPart = "hangdroid_"+ badLetterCount;

       //imageView.setImageResource(R.drawable.hangPart);
    ...
    public void gameOver(){
        ...
        intent.putExtra("wordID",theWord);
    ...
    private void setNewWord(){
        ...
        Log.d("MYLOG","Word Array length: "+ wordArray.length);

        int randNum = (int) (Math.random() * wordArray.length);
        Log.d("MYLOG","Random Number: "+ randNum);

        theWord = wordArray[randNum];
        Log.d("MYLOG","Word is: "+ theWord);
    }
